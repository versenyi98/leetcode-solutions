...
from readme_content_providers import LeetCodeContentProvider
...
def main():
    ...
    solutions_folder = base_path / "solutions"
    generate_readme(solutions_folder, LeetCodeContentProvider())

    with open(base_path / "README.md", "w") as readme_handle:
        readme_handle.write(f"### LeetCode Solutions\n")

        with open(solutions_folder / "README.md", "r") as sub_readme_handle:
